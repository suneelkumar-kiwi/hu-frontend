...
export default function CreateAccountDrawer({ show, onHide, showRequestSentModal }: CreateAccountProps) {
    ...
    return (
        <Offcanvas
            ...
            onHide={onHide}
            placement="end"
            className="create-account-offcanvas"
        >
            <Squircle cornerRadius={80} as={'div'} className="squircle-wrapper">
                ...
                <Offcanvas.Body>
                    {/* ── Personal Details ── */}
                    <Squircle cornerRadius={40} as={'div'} className="data-section">
                        <h6 className="data-section__title">Personal Details</h6>
                    ...
                    {/* ── Your Care Journey ── */}
                    <Squircle cornerRadius={40} as={'div'} className="data-section">
                        <h6 className="data-section__title">Your Care Journey</h6>
                    ...
                    {/* ── Privacy notice ── */}
                    <Squircle cornerRadius={80} as={'div'} className="offcanvas-privacy">
                        <FormCheck
                            type="checkbox"
                            label="You accept that when you submit the form, we process the personal
                                data you provide."
                            id="privacy-check"
                            required
                        />
                        <p className="offcanvas-privacy__sub">
                    ...
                    <Button variant="primary" type="submit" className="signup-btn" onClick={() => { showRequestSentModal(); onHide(); }}>
                        Sign Up
                    </Button>
                </Offcanvas.Body>
            </Squircle>
